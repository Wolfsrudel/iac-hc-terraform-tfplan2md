...
Generated by tfplan2md 1.25.0 (efa2118) on 2026-02-21 13:21:29 UTC | Terraform 1.14.0
...
<summary>➕ azurerm_role_assignment <b><code>create_no_description</code></b> — <code>👤 Jane Doe</code> → <code>🛡️ Reader</code> on <code>📁 rg-tfplan2md-demo</code></summary>
<br>
...
| principal_id | `👤 Jane Doe (User)` [`11111111-1111-1111-1111-111111111111`] |
| principal_type | `👤 User` |
| name | `🆔 ra-create` |
...
<details style="margin-bottom:12px; border:1px solid rgb(var(--palette-neutral-10, 153, 153, 153)); padding:12px;">
<summary>➕ azurerm_role_assignment <b><code>create_with_description</code></b> — <code>👥 DevOps Team</code> → <code>🛡️ Storage Blob Data Reader</code> on Storage Account <code>sttfplan2mdlogs-with-extended-name-1234567890</code></summary>
<br>
...
| principal_id | `👥 DevOps Team (Group)` [`22222222-2222-2222-2222-222222222222`] |
...
<details style="margin-bottom:12px; border:1px solid rgb(var(--palette-neutral-10, 153, 153, 153)); padding:12px;">
<summary>🔄 azurerm_role_assignment <b><code>update_assignment</code></b> — <code>👥 Security Team</code> → <code>🛡️ Storage Blob Data Contributor</code> on Storage Account <code>sttfplan2mddata</code></summary>
<br>
...
<details style="margin-bottom:12px; border:1px solid rgb(var(--palette-neutral-10, 153, 153, 153)); padding:12px;">
<summary>♻️ azurerm_role_assignment <b><code>replace_assignment</code></b> — recreate as <code>👥 Security Team</code> → <code>🛡️ Custom Contributor Long Name 1234567890</code> on <code>📁 rg-production</code></summary>
<br>
...
<details style="margin-bottom:12px; border:1px solid rgb(var(--palette-neutral-10, 153, 153, 153)); padding:12px;">
<summary>❌ azurerm_role_assignment <b><code>delete_assignment</code></b> — remove <code>🛡️ Contributor</code> on <code>📁 rg-legacy</code> from <code>👤 Security Team</code></summary>
<br>
